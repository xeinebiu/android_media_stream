package com.xeinebiu.media_streamer
...
import com.xeinebiu.media_streamer.util.createHttpURLConnection
import com.xeinebiu.media_streamer.util.getContentLength
import com.xeinebiu.media_streamer.util.getIPAddress
...
class MediaStreamerService : Service() {
    ...
    private fun startCasting(
        ...
        val streamOpenCallback: () -> InputStream = {
            if (isOnline)
                ...
                this@MediaStreamerService.contentResolver.openInputStream(streamUri)!!
        }
    ...
    private fun showCastNotification(
        ...
        val cancelIntent = Intent(this, MediaStreamerService::class.java)
    ...
    companion object {
        ...
        fun stream(
            ...
            val intent = Intent(context, MediaStreamerService::class.java)
